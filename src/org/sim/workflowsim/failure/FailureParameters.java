...
public class FailureParameters {
     ...
     */
    private static DistributionGenerator.DistributionFamily distribution = DistributionGenerator.DistributionFamily.WEIBULL;
    /**
    ...
    public static void init(FTCluteringAlgorithm fMethod, FTCMonitor monitor, 
            FTCFailure failure, DistributionGenerator[][] failureGenerators, 
            DistributionGenerator.DistributionFamily dist) {
        distribution = dist;
     ...
     * @return distribution
     */
    public static DistributionGenerator.DistributionFamily getFailureDistribution(){
        return distribution;
    }
}
